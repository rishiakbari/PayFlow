...
class Colorz {
  // App theme colors
  static const Color main = Color(0xffD36221);
  ...
  // Grediants
  static const Color gradient1 = Color(0xffD36221);
  static const Color gradient2 = Color(0xffF2AD3C);
  static const Color gradient3 = Color(0xffD8A537);
  ...
  static Color buttonShadow = const Color(0xffD36221).withOpacity(0.5);
