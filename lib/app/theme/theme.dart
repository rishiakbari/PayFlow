...
ThemeData buildLightThemeData(BuildContext context) {
  return ThemeData(
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      ...
      unselectedItemColor: Colorz.primaryBackground,
...
ThemeData buildDarkThemeData(BuildContext context) {
  return ThemeData(
    ...
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        backgroundColor: WidgetStateProperty.all(Colorz.main),
        shape: WidgetStateProperty.all(
          const RoundedRectangleBorder(
            borderRadius: BorderRadius.all(
    ...
    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: Colorz.main,
      selectionColor: Colorz.textWhite,
      selectionHandleColor: Colorz.main,
    ),
    inputDecorationTheme: InputDecorationTheme(
      focusedBorder: OutlineInputBorder(
    ...
    datePickerTheme: DatePickerThemeData(
      todayBackgroundColor: const WidgetStatePropertyAll(Colorz.main),
      dayForegroundColor: WidgetStateProperty.resolveWith<Color?>(
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.selected)) {
            return Colorz.main; // Color for selected date
          }
          return Colorz.textWhite; // Use default color for other dates
        },
      ),
    ),
    // textTheme: GoogleFonts.montserratTextTheme().copyWith(),
